package com.loftschool.helloworld.presentation.login;
...
import com.loftschool.helloworld.presentation.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.loftschool.helloworld.R.layout.activity_login);
    ...
    private void configureViews() {
        AppCompatButton loginEnterView = findViewById(com.loftschool.helloworld.R.id.loginEnterView);
    ...
    private void configureViewModel() {
        ...
        loginViewModel.authToken.observe(this, authToken -> {
            if (!TextUtils.isEmpty(authToken)) {
                SharedPreferences sharedPreferences = getSharedPreferences(getString(com.loftschool.helloworld.R.string.app_name), 0);
